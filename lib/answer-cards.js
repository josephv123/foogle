...
export function calcCard(d) {
  ...
  return card("calculator", `<div class="ia-calc-screen"><div class="ia-calc-top">${esc(d.shown)} =</div><div class="ia-calc-main">${esc(fmt(d.value))}</div></div><div class="ia-keys">${keys}</div>`, { value: d.value }, ' tabindex="0" aria-label="Calculator"');
}
...
<div class="ia-time-where">Time in ${esc(d.place)}</div><div class="ia-time-rel"></div>`, { tz: d.tz, utcOffset: d.utcOffset, abbr: d.abbr });
}
