...
function picture(plan, prompt, shape, cls = "art") {
  ...
  return `<img class="${cls}" src="/img/${imgPath(prompt.slice(0, 300))}?s=${designMedium(plan)}&amp;a=${shape}&amp;bg=${encodeURIComponent(c.panel)}&amp;fg=${encodeURIComponent(c.acc)}" alt="" onload="this.style.opacity=1">`;
}
